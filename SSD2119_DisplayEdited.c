...
static void LCD_GPIOInit(void){
    ...
    // K5
    RCGCGPIO |= 0x208;                          // activate port K
    wait++;                                     // wait for port activation
    wait++;                                     // wait for port activation
    ...
    // M7
    RCGCGPIO |= 0xA08;                          // activate port M
    wait++;                                     // wait for port activation
    wait++;                                     // wait for port activation
    ...
    // N4, N5
    RCGCGPIO |= 0x1A08;                         // activate port N
    wait++;                                     // wait for port activation
    wait++;                                     // wait for port activation
    ...
    // P0, P1, P3, P4
    RCGCGPIO |= 0x3A08;                         // activate port P
    wait++;                                     // wait for port activation
    wait++;                                     // wait for port activation
    ...
    // Q0, Q2, Q3
    RCGCGPIO |= 0x7A08;                          // activate port Q
    wait++;                                      // wait for port activation
    wait++;                                      // wait for port activation
